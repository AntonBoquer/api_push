...
class SupabaseClient:
    ...
    async def insert_data(self, table_name: str, json_data: dict):
        ...
        try:
            # Prepare data for the simplified schema (id, created_at, uuid, json_data)
            # Extract uuid if it exists to store it as a separate column
            data = {
                "json_data": json_data
                # id and created_at will be auto-generated by the database
            }
            
            # If uuid exists in json_data, extract it to a separate column
